...
import os
import numpy as np
from search_in_documents import search_in_documents
...
def load_selected_model(model_name):
    ...
    chat_history = []
    return redirect(url_for('Unibus')), chat_history
...
def get_response_from_model(query, history):
    try:
        ...
        outputs = model.generate(inputs, max_length=400, do_sample=True, temperature=0.6, top_p=0.7, eos_token_id=terminators,no_repeat_ngram_size=4)
